  ...
  return (
    <section className="block md:flex md:items-center md:justify-between md:mb-4">
      ...
      <div className="my-2 h-full flex justify-between px-4 sm:items-center sm:pr-36">
        <div className="">
          <h2 data-testid="recipe-title" className="text-2xl border-b border-gray-900 md:text-7xl   md:font-serif">{ recipe[ref.strTitle] }</h2>
          <h3 data-testid="recipe-category" className="text-center text-gray-800   md:font-serif md:text-5xl">{ recipe[ref.strCateg] }</h3>
        </div>
        <div>
